      ...
      <div class="nav-logo">
        <a href="index.html">
          ...
          <div
            ...
            style="background-image: url('/images/logo/logo-white.png')"
          ></div>
        </a>
      </div>
      <ul class="nav-left">
        <li>
          <a class="sidenav-fold-toggler" @click="toogleSideNav()">
        ...
        <li class="search-input">
          ...
          <div class="search-predict">
            ...
            <div class="search-footer">
              <span
                >You are Searching for '<b class="text-dark"
                  ><span class="serach-text-bind"></span></b
                >'</span
              >
            </div>
          </div>
      ...
      <ul class="nav-right">
          ...
          <ul class="dropdown-menu dropdown-grid col-3 dropdown-lg">
            <li>
              <a href="#">
                <div class="text-center">
                  <i
                    class="mdi mdi-email-outline font-size-30 icon-gradient-success"
                  ></i>
            ...
            <li>
              <a href="#">
                <div class="text-center">
                  <i
                    class="mdi mdi-folder-outline font-size-30 icon-gradient-success"
                  ></i>
            ...
            <li>
              <a href="#">
                <div class="text-center">
                  <i
                    class="mdi mdi mdi-gauge font-size-30 icon-gradient-success"
                  ></i>
            ...
            <li>
              <a href="#">
                <div class="text-center">
                  <i
                    class="mdi mdi-play-circle-outline font-size-30 icon-gradient-success"
                  ></i>
            ...
            <li>
              <a href="#">
                <div class="text-center">
                  <i
                    class="mdi mdi-image-filter font-size-30 icon-gradient-success"
                  ></i>
            ...
            <li>
              <a href="#">
                <div class="text-center">
                  <i
                    class="mdi mdi-image-filter-drama font-size-30 icon-gradient-success"
                  ></i>
        ...
        <li class="notifications dropdown dropdown-animated scale-left">
          ...
          <ul class="dropdown-menu dropdown-lg p-v-0">
            ...
            <li>
              <ul
                class="list-media overflow-y-auto relative scrollable"
              ...
              >
                ...
                <li class="list-item border bottom">
                  <a href="javascript:void(0);" class="media-hover p-15">
                    ...
                    <div class="info">
                      <span class="title"> New Order Received </span>
                      <span class="sub-title">12 min ago</span>
                    </div>
                  </a>
                </li>
            ...
            <li class="p-v-15 p-h-20 text-center">
              <span>
                <a href="#" class="text-gray"
                  ...
                  <i class="ei-right-chevron p-l-5 font-size-10"></i
                ></a>
              </span>
            </li>
          </ul>
        ...
        <li class="user-profile dropdown dropdown-animated scale-left">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">
            <img
              ...
              src="/images/avatars/thumb-13.jpg"
              alt=""
            />
          </a>
            ...
            <li>
              <ul class="list-media">
                <li class="list-item p-15">
                  <div class="media-img">
                    <img src="/images/avatars/thumb-13.jpg" alt="" />
                  </div>
                  <div class="info">
